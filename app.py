...
# Judul diperkecil menggunakan Markdown Header (###) agar elegan di layar HP
...
# --- KONDISI LAHAN ---
st.sidebar.markdown("#### Kondisi Lahan Awal")
...
# --- PENGATURAN KEUANGAN ---
st.sidebar.markdown("#### Pengaturan Keuangan")
...
if jenis_bangunan == "0. Pekerjaan Persiapan":
    st.sidebar.markdown("**Item Persiapan (Lump Sum)**")
...
# =====================================================================
    ...
    st.sidebar.markdown("**Dimensi Saluran**")
    ...
    st.sidebar.markdown("**Pekerjaan & AHSP**")
...
# =====================================================================
    ...
    st.sidebar.markdown("**Dimensi Drainase**")
...
# =====================================================================
    ...
    st.sidebar.markdown("**Dimensi Jalan**")
...
# =====================================================================
    ...
    st.sidebar.markdown("**Dimensi Rigid**")
...
# =====================================================================
    ...
    st.sidebar.markdown("**Dimensi Pondasi**")
...
# =====================================================================
    ...
    st.sidebar.markdown("**Dimensi DPT**")
...
# =====================================================================
    ...
    st.sidebar.markdown("**Dimensi Bore Pile**")
...
if st.session_state.rekap_proyek:
    st.sidebar.divider()
    st.sidebar.markdown("#### ✏️ Edit Item Tersimpan")
    st.sidebar.caption("Pilih rincian di bawah untuk menyesuaikan ulang Volumenya:")
    ...
    if pilihan_edit != "-- Pilih Item --":
        ...
        val_vol = st.sidebar.number_input(f"Edit Volume Akhir ({item_terpilih['Satuan']})", value=float(vol_hitung), key=f"ev_{idx_edit}_{persen_adj}")
        val_ahsp = st.sidebar.number_input("Edit AHSP Akhir (Rp)", value=float(item_terpilih['AHSP']), key=f"ea_{idx_edit}")
        
        col_e1, col_e2 = st.sidebar.columns(2)
        with col_e1:
            if st.button("💾 Update", key=f"upd_{idx_edit}"):
                ...
                st.rerun()
        with col_e2:
            if st.button("🗑️ Hapus", key=f"del_{idx_edit}"):
                st.session_state.rekap_proyek.pop(idx_edit)
                st.rerun()

# =====================================================================
# MANAJEMEN DRAFT PROYEK (SAVE/LOAD)
# =====================================================================
st.sidebar.divider()
st.sidebar.markdown("#### 📁 Manajemen Draft Proyek")
...
if st.session_state.rekap_proyek:
    ...
    st.sidebar.caption("Simpan sebagai draft agar perhitungan tidak hilang jika browser tertutup.")
...
st.caption(f"**Kategori:** {kategori_pekerjaan}")
